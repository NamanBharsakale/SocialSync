...
function AIComposer() {
  ...
  const handleSchedule = async () => {
    ...
    const dateTime = new Date(`${scheduledDate}T${scheduleTime}:00`);
    ...
    try {
      await api.post("/api/posts", {
        ...
        mediaUrl: activeSchedular.mediaKey || activeSchedular.mediaUrl,
        ...
        <div className="relative group mt-12">
          ...
          <div className="absolute bottom-2.5 right-2.5 flex items-center gap-3 text-sm">
            ...
            >
              ...
              >
                <span
                  className={`pointer-events-none size-4 transform translate 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          {generations.length === 0 && (
            <div className="col-span-full py-20 text-center space-y-2">
              ...
              <p className="text-slate-400 text-shadow-mauve-950">
