  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-500 text-sm mt-0.5">Here's what's happening with your social accounts today.
          ...
          {activities.length === 0? (
            ...
            <div className="divide-y divide-slate-50">
                {activities.map((activity)=>(
                  ...
                  flex items-start gap-4 px-6 py-4 hover:bg-slate-50/50 transition-colors">
